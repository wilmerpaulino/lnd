...
const (
	...
	// ExplicitChannelTypeOptional is a bit that denotes that a connection
	// established with this node is to use explicit channel commitment
	// types for negotiation instead of the existing implicit negotiation
	// methods. With this bit, there is no longer a "default" implicit
	// channel commitment type, allowing a connection to open/maintain types
	// of several channels over its lifetime.
	ExplicitChannelTypeOptional = 2020

	// ExplicitChannelTypeRequired is the required variant of the
