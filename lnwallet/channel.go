...
func newOutgoingHtlcResolution(signer input.Signer,
	...
	if !localCommit {
		...
		return &OutgoingHtlcResolution{
			...
			ClaimOutpoint:   op,
			SweepSignDesc:   input.SignDescriptor{KeyDesc: localChanCfg.HtlcBasePoint, SingleTweak: keyRing.LocalHtlcKeyTweak, WitnessScript: htlcScript, Output: &wire.TxOut{PkScript: htlcScriptHash, Value: int64(htlc.Amt.ToSatoshis())}, HashType: txscript.SigHashAll},
		}, nil
	}
