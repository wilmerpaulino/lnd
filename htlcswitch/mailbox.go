...
// courierType is an enum that relfect the distinct types of messages a mailBox
// can handle. Each type will be placed in an isolated mail box and will have a
// dedicated goroutine for delivering the messages.
